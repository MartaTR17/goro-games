...
class __TwigTemplate_4549fe56edbcd129ae5120dad0c38c70 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t";
        ...
        if (($context["NOTIFICATIONS_COUNT"] ?? null)) {
            ...
            echo "\" class=\"check\" title=\"";
            echo $this->extensions['phpbb\template\twig\extension']->lang("MARK_ALL_READ");
            echo "\" data-ajax=\"notification.mark_all_read\"></a></span>
\t\t\t\t";
        }
        // line 11
        echo "\t\t\t</span>
